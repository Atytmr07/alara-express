  ...
  return (
    <article className="overflow-hidden rounded-2xl border border-line bg-foam shadow-warm">
      <div
        ...
        aria-label={`${product.name}, ${formatPrice(product.price)}. Ayrıntılar için dokunun.`}
        onClick={toggle}
        onKeyDown={onKeyDown}
        className="flex w-full items-stretch text-left outline-none focus-visible:ring-2 focus-visible:ring-sea focus-visible:ring-offset-2"
      >
        {/* Image (left ~38%) */}
      ...
      {/* Inline expand: allergens + freshness note */}
